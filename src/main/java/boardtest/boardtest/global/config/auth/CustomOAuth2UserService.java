package boardtest.boardtest.global.config.auth;
...
import boardtest.boardtest.domain.member.repository.MemberSocialRepository;
import boardtest.boardtest.global.config.auth.dto.OAuthAttributes;
import boardtest.boardtest.global.config.auth.dto.SessionUser;
